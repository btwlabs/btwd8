...
namespace Drupal\shipstation_commerce\Encoder;
 ...
 *   service.
 */
class ShipstationXmlEncoder implements SerializerAwareInterface, EncoderInterface {
   ...
   * @var array
   */
  static protected $format = ['shipstation_xml'];
  ...
  public function getBaseEncoder() {
    if (!isset($this->baseEncoder)) {
      $this->baseEncoder = new BaseXmlEncoder('Orders');
