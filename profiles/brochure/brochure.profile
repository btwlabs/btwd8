...
function brochure_form_install_configure_submit($form, FormStateInterface $form_state) {
  ...
  $feeds['media'] = \Drupal::entityTypeManager()->getStorage('feeds_feed')->create(array(
    ...
    'status' => 1,
    'created' => time(),
    'source' => 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRplpEYGyG7K4Um7_ZuU064ja2zh9kgkQun1nMed3axUU96yyDo_EANpw4E9Awx4hjYD-_dHsBWAz1N/pubhtml?gid=728747965&single=true',
  ))->save();
  ...
  $feeds['teammember_feed'] = \Drupal::entityTypeManager()->getStorage('feeds_feed')->create(array(
    ...
    'status' => 1,
    'created' => time(),
    'source' => 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRplpEYGyG7K4Um7_ZuU064ja2zh9kgkQun1nMed3axUU96yyDo_EANpw4E9Awx4hjYD-_dHsBWAz1N/pubhtml?gid=2074362618&single=true',
  ))->save();
