...
templates. For an overview on what has been done, refer to custom_admin.info.yml and thunder_admin.libraries.yml where
...
Theme should be installed in correct Drupal environment (expected to be in: `[docroot]/themes/contrib/custom_admin`).
...
- replace installed custom_admin theme with the one including your changes by copying or making a symbolic link 
